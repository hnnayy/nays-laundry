...
class FormPendaftaranPelanggan extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->createTable('form_pelanggan'); // Ubah penamaan tabel disini
    }

    public function down()
    {
        $this->forge->dropTable('form_pelanggan'); // Ubah penamaan tabel disini
    }
}
